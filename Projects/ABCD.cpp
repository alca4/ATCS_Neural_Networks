...
* another hidden layer with C nodes,
...
struct NeuralNetwork 
{
   ...
   */
   ...
   const int FIRST_HIDDEN_LAYER = 1;                  // 1st hidden layer is the 1st layer
   const int SECOND_HIDDEN_LAYER = 2;                 // 2nd hidden layer is the 2nd layer
   ...
   */
   void learn()
   {
      for (int j = 0; j < activationLayerSize[SECOND_HIDDEN_LAYER]; j++)
      {
         ...
         psi[SECOND_HIDDEN_LAYER][j] = omega[SECOND_HIDDEN_LAYER][j] * 
                                       thresholdFunctionDerivative(theta[SECOND_HIDDEN_LAYER][j]);
      } // for (int j = 0; j < activationLayerSize[SECOND_HIDDEN_LAYER]; j++)
      ...
      for (int k = 0; k < activationLayerSize[FIRST_HIDDEN_LAYER]; k++)
      {
         ...
         psi[FIRST_HIDDEN_LAYER][k] = omega[FIRST_HIDDEN_LAYER][k] * 
                                      thresholdFunctionDerivative(theta[FIRST_HIDDEN_LAYER][k]);
